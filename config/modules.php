    ...
    'paths' => [
        ...
        */
        'generator' => [
            ...
            'emails' => ['path' => 'src/App/Emails', 'generate' => false],
            'event' => ['path' => 'src/App/Events', 'generate' => true],
            'enums' => ['path' => 'src/App/Enums', 'generate' => true],
            'exceptions' => ['path' => 'app/Exceptions', 'generate' => false],
            'jobs' => ['path' => 'app/Jobs', 'generate' => false],
            'helpers' => ['path' => 'app/Helpers', 'generate' => false],
            'interfaces' => ['path' => 'src/App/Interfaces', 'generate' => true],
            'listener' => ['path' => 'src/App/Listeners', 'generate' => false],
            'model' => ['path' => 'src/App/Models', 'generate' => true],
            'notifications' => ['path' => 'src/App/Notifications', 'generate' => false],
            'observer' => ['path' => 'src/App/Observers', 'generate' => false],
            'policies' => ['path' => 'src/App/Policies', 'generate' => false],
            'provider' => ['path' => 'src/App/Providers', 'generate' => true],
            'repository' => ['path' => 'src/App/Repository', 'generate' => true],
            'resource' => ['path' => 'app/Transformers', 'generate' => false],
            'route-provider' => ['path' => 'src/App/Providers', 'generate' => true],
            'rules' => ['path' => 'app/Rules', 'generate' => false],
            'services' => ['path' => 'src/App/Services', 'generate' => true],
            'scopes' => ['path' => 'app/Models/Scopes', 'generate' => false],
            'traits' => ['path' => 'app/Traits', 'generate' => false],

            // app/Http/
           'controller' => ['path' => 'src/App/Http/Controllers', 'generate' => true],
            'request' => ['path' => 'src/App/Http/Requests', 'generate' => true],
